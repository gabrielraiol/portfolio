export const socialProfiles = [
  { label: 'GitHub', url: 'https://github.com/gabrielraiol', icon: '/assets/github.svg' },
  { label: 'LinkedIn', url: 'https://www.linkedin.com/in/gabrielraiol', icon: '/assets/linkedin.svg' },
